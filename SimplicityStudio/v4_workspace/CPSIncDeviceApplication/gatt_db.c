...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_33 ) = {
	.len=19,
	.data={0x0a,0x23,0x00,0xa1,0x5e,0x6d,0xd7,0x76,0xfa,0x1b,0x8d,0x96,0x45,0xb6,0xae,0xc9,0x8d,0xc7,0x3d,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_30 ) = {
	.len=19,
	.data={0x12,0x20,0x00,0xf1,0xaf,0xb1,0x96,0x66,0x06,0x41,0xbb,0xa8,0x42,0x1c,0xc7,0x55,0xbb,0x5c,0x21,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=19,
	.data={0x12,0x1d,0x00,0x5d,0xed,0xb6,0x36,0x5c,0xd1,0x3d,0xb2,0xe7,0x4a,0xdc,0xb6,0x70,0xf2,0xd8,0x57,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_24 ) = {
	.len=19,
	.data={0x12,0x1a,0x00,0x1f,0xcc,0xe2,0xc1,0xfd,0x8e,0xfe,0xb2,0xc2,0x4c,0x6d,0xf6,0xc6,0x19,0x6b,0x64,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x8004,.permissions=0x801,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_28},
    ...
    {.uuid=0x8005,.permissions=0x801,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_31},
    ...
    {.uuid=0x8006,.permissions=0x803,.caps=0xffff,.datatype=0x01,.min_key_size=0x00,.dynamicdata=&bg_gattdb_data_attribute_field_34},
};
