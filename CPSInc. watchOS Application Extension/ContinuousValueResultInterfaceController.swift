//
//  ContinuousValueResultInterfaceController.swift
...
public class ContinuousValueResultInterfaceController: WKInterfaceController, WKCrownDelegate, WCSessionDelegate{
    ...
    var optionsPickerData = [WKPickerItem]()
    ...
    override public func willActivate() { //equivalent of viewDidLoad
        ...
        if WCSession.isSupported() {
            ...
            print("wcSession has been activated on iWatch - ContinuousValueResultInterfaceController")
        }
    ...
    public func session(_ session: WCSession, didReceiveApplicationContext applicationContext: [String : Any]) {
        if(applicationContext["ContinuousValueFinalTestResult"] != nil){
