...
public class TestPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, CBPeripheralDelegate {
    ...
    public func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        let currentIndex: Int = pages.firstIndex(of: viewController as! TestViewController)!
        if(currentIndex == 0){
            return nil
        }
    ...
    public func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        self.pageControl.currentPage = pages.firstIndex(of: pageContentViewController as! TestViewController)!
    }
    ...
    public func getTestPages() -> [TestViewController]{
        return pages
    }
