...
//
//  Created by Colton on 2019-08-09.
...
public class OriginalTestPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, CBPeripheralDelegate {
    ...
    var pages = [OriginalTestViewController]()
    ...
    public func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        let currentIndex: Int = pages.firstIndex(of: viewController as! OriginalTestViewController)!
        if(currentIndex == 0){
            return nil
        }
        
        pages[currentIndex].getWCSession().delegate = pages[currentIndex - 1]
        pages[currentIndex - 1].setWCSession(session: pages[currentIndex].getWCSession())
    ...
    public func pageViewController(_ pageViewController: UIPageViewController, didFinishAnimating finished: Bool, previousViewControllers: [UIViewController], transitionCompleted completed: Bool) {
        ...
        self.pageControl.currentPage = pages.firstIndex(of: pageContentViewController as! OriginalTestViewController)!
    }
...
//                    }
    ...
    public func addPage(pageToAdd: OriginalTestViewController?){
    ...
    public func getTestPages() -> [OriginalTestViewController]{
        return pages
    }
