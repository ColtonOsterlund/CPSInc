...
public class OriginalTestViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, WCSessionDelegate{
    ...
    private var testPageController: OriginalTestPageViewController? = nil
...
//    var isFinalValueTest: Bool? = nil //if true - final value test, if false - continuous value test
    ...
    public convenience init(menuView: MenuViewController, appDelegate: AppDelegate?, testPageController: OriginalTestPageViewController?) {
...
//            }
    ...
    @objc private func addTestBtnPressed(){ //this adds a page to the testPageViewController where you can start another test
        ...
        let newTestView = OriginalTestViewController(menuView: self.menuView!, appDelegate: self.appDelegate, testPageController: self.testPageController)
        if(wcSession != nil){
...
@available(iOS 12.0, *)
extension OriginalTestViewController {
...
@available(iOS 12.0, *)
extension OriginalTestViewController: INUIAddVoiceShortcutViewControllerDelegate {
