...
//MIGRATION POLICY WRITTEN TO GO FROM V1 TO V2, HOWEVER NOW WE HAVE RETURNED TO USING V1. NO POLICY WAS CREATED FROM V2 TO V1, IT WAS AT AN EARLY ENOUGH STAGE TO DELETE FROM EVERYBODIES PHONES AND REDOWNLOAD
